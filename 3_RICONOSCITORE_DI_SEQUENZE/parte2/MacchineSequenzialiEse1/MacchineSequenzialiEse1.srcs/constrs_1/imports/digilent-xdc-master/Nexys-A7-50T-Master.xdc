...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { S2 }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { B2 }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { B1 }]; #IO_L4N_T0_D05_14 Sch=btnuàset_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { B1 }]; #IO_L12P_T1_MRCC_14 Sch=btnl
