...
HD_PWD='C:/Users/mario/OneDrive/Desktop/molt_booth_finale/molt_booth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log molt_booth_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source molt_booth_on_board.tcl -notrace
