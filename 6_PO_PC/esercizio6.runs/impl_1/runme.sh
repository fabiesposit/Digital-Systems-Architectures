...
HD_PWD='C:/Users/mario/OneDrive/Desktop/esercizio6/esercizio6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_les_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_les_on_board.tcl -notrace
