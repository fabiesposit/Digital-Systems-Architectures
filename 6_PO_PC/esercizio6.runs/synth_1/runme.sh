...
HD_PWD='C:/Users/mario/OneDrive/Desktop/esercizio6/esercizio6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_les_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_les_on_board.tcl
