...
HD_PWD='C:/Users/Utente/Dropbox/LABORATORIO/ASDi/CRONOMETRO_ES5/5_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometro_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cronometro_on_board.tcl
