...
HD_PWD='C:/Users/Utente/Dropbox/LABORATORIO/ASDi/CRONOMETRO_ES5/5_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometro_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometro_on_board.tcl -notrace
