...
HD_PWD='C:/Users/mario/OneDrive/Desktop/ROM_ON_BOARD2/ROM_ON_BOARD2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_on_board.tcl
