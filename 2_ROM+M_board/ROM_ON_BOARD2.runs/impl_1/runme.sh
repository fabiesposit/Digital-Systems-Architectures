...
HD_PWD='C:/Users/mario/OneDrive/Desktop/ROM_ON_BOARD2/ROM_ON_BOARD2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_on_board.tcl -notrace
